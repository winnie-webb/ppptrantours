...
/**
 * Links are locale-less on purpose. A not-found page renders outside the
 * `[locale]` params, so there is no locale to read here — the middleware sends
 * `/` to the default language and a prefixed 404 keeps its own prefix.
 */
